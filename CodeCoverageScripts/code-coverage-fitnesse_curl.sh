...
##Get Current Total number of lines
    curl --user ykhandelwal:d281b39fd700529e65201fcab6822779 -k ${BUILD_URL}jacoco/api/xml --output $IT_COVERAGE_XML
...
#Get Previous Total number of lines
    curl --user ykhandelwal:d281b39fd700529e65201fcab6822779 -k ${JOB_URL}lastSuccessfulBuild/jacoco/api/xml --output $IT_PREV_COVERAGE_XML
