...
##### Extract CURRENT Unit Test Results
    curl --user ykhandelwal:85e0b077821e653f3f99b4c24d29b1e3 ${BUILD_URL}testReport/api/xml --output $JUNIT_XML
...
##### Extract PREVIOUS Unit Test Results
    curl --user ykhandelwal:85e0b077821e653f3f99b4c24d29b1e3 ${JOB_URL}lastSuccessfulBuild/testReport/api/xml --output $JUNIT_PREV_XML
...
##Get Current Total number of lines
	curl --user ykhandelwal:85e0b077821e653f3f99b4c24d29b1e3 ${BUILD_URL}jacoco/api/xml --output $UT_COVERAGE_XML
...
#Get Previous Total number of lines
	curl --user ykhandelwal:85e0b077821e653f3f99b4c24d29b1e3 ${JOB_URL}lastSuccessfulBuild/jacoco/api/xml --output $UT_PREV_COVERAGE_XML
